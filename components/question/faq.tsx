    ...
    return (
        <Accordion type="single" collapsible className="w-full xl:w-[80%]  ">
            <AccordionItem className="w-full" value="item-1">
                <AccordionTrigger className="font-bold text-xl text-left max-md:text-base">İşletme misyonumuz hangi değerleri yansıtmaktadır?</AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-5">
                <AccordionTrigger className="font-bold text-left text-xl max-md:text-base">Müşteri memnuniyeti için hangi önlemleri alıyoruz?</AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-6">
                <AccordionTrigger className="font-bold text-left text-xl max-md:text-base">Tesislerinizde hangi hizmetler mevcut? </AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-7">
                <AccordionTrigger className="font-bold text-left text-xl max-md:text-base">Sorularım veya endişelerim için kime başvurabilirim??</AccordionTrigger>
                <AccordionContent>
